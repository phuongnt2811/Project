            ...
            <div class="container-form">
                ...
                <ul class="list-group">
                    <c:forEach var="teacher" items="${listTeacher}" 
                        ...
                        <form action="InformationTeacherServlet" method="POST">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination mt-4">
                        <c:if test = "${prev eq true}">
                            <li class="page-item"><a class="page-link" href="InforTeacherServlet?page=${p-1}">Previous</a></li>
                            </c:if>
                            <c:forEach var="i" begin="${btnStart}" end="${btnEnd}">
                            <li class="page-item"><a class="page-link" href="InforTeacherServlet?page=${i}">${i}</a></li>
                            </c:forEach>
                            <c:if test = "${next eq true}" >
                            <li class="page-item"><a class="page-link" href="InforTeacherServlet?page=${p+1}">Next</a></li>
                            </c:if>
                    </ul>
                </nav>
