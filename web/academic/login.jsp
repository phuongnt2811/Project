    ...
    <body>
        <div class="container">
            <div class="container-login">
                ...
                <h1>Login</h1>
                <form action="AcademicLoginServlet" method="POST">
                    ...
                    <div class="form-group">
                        <a href="UpdatePassServlet">Forgot password?</a><br>
                    </div>
                    <button type="submit" class="btn btn-primary">Login</button>
                </form>
                <div class="btn-group mt-3" role="group" aria-label="Basic outlined example">
                    <a href="../index.html"><button type="button" class="btn btn-outline-primary">Trở về trang chủ</button></a>
                </div>
            </div>
        </div>
    </body>
