            ...
            <div class="container-form">
                ...
                <ul class="list-group">
                    <c:forEach var="news" items="${ListNews}" 
                        ...
                        <form action="InforNewsServlet" method="POST">
                            <li class="list-group-item">${news.title}
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination mt-4">
                        <c:if test = "${prev eq true}">
                            <li class="page-item"><a class="page-link" href="DeleteNewsServlet?page=${p-1}">Previous</a></li>
                            </c:if>
                            <c:forEach var="i" begin="${btnStart}" end="${btnEnd}">
                            <li class="page-item"><a class="page-link" href="DeleteNewsServlet?page=${i}">${i}</a></li>
                            </c:forEach>
                            <c:if test = "${next eq true}" >
                            <li class="page-item"><a class="page-link" href="DeleteNewsServlet?page=${p+1}">Next</a></li>
                            </c:if>
                    </ul>
                </nav>
