            ...
            <div class="container-form">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="ReviewWebServlet">Infor Admin</a>
                            </li>
                            <li class="nav-item">
                ...
                <ul class="list-group">
                    <c:forEach var="student" items="${ListStudent}" 
                        ...
                        <form action="MoveOutClassServlet" method="Post">
                            <li class="list-group-item">${student.firstName} ${student.lastName}
                                <input type="hidden" value="${student.id}" name="studentId" />
                                <select name="cl">
                                    <c:forEach items="${LstClass}" var="lst">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination mt-4">
                        <c:if test = "${prev eq true}">
                            <li class="page-item"><a class="page-link" href="InformationClassServlet?page=${p-1}&classId=${clId}">Previous</a></li>
                            </c:if>
                            <c:forEach var="i" begin="${btnStart}" end="${btnEnd}">
                            <li class="page-item"><a class="page-link" href="InformationClassServlet?page=${i}&classId=${clId}">${i}</a></li>
                            </c:forEach>
                            <c:if test = "${next eq true}" >
                            <li class="page-item"><a class="page-link" href="InformationClassServlet?page=${p+1}&classId=${clId}">Next</a></li>
                            </c:if>
                    </ul>
                </nav>
                </c:if>
