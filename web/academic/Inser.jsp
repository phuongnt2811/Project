    ...
    <body>
        <div class="container">
            <div class="container-form">
                ...
                <form action="InsertNewServlet" method="POST">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control input-student" name="title">
                    </div>
                    <div class="form-group">
                        <label>Content</label>
                        <textarea class="form-control input-student" name="content"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <input type="text" class="form-control input-student" name="des">
                    </div>
                    <div class="form-group">
                        <label>Cover</label>
                        <input type="file" class="form-control input-student" name="cover">
                    </div>
                    <div class="form-group">
                        <label>Created Date</label>
                        <input type="text" class="form-control input-student" name="date">
                    </div>
                    <button type="submit" class="btn btn-success botton-academic">Insert</button>
                </form>
            </div>
        </div>        
    </body>
