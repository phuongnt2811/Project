            ...
            <div class="container-form">
                ...
                <form action="UpdateNewsServlet" method="Post">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control input-student" name="title" value="${News.title}" >
                    </div>
                    <div class="form-group">
                        <label>Content</label>
                        <textarea class="form-control input-student" name="content" >${News.content}</textarea>
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <input type="text" class="form-control input-student" name="des" value="${News.description}" >
                    </div>
                    <div class="form-group">
                        <label>Cover</label>
                        <input type="file" class="form-control input-student" name="cover" value="${News.images}" >
                    </div>
                    <div class="form-group">
                        <label>Created Date</label>
                        <input type="text" class="form-control input-student" name="date" value="${News.createddate}" >
                    </div>
                    <input type="hidden" name="id" value="${News.id}">
                    <button type="submit" class="btn btn-success botton-academic">Save</button>
                    <!--<button type="submit" class="btn btn-danger botton-academic" formaction="DeleteNewsServlet">Delete</button>-->
                </form>
            </div>
        </div>        
    </body>
